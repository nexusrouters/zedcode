...
const STORE_PATH = "zedcode-ssh-connections.json";
const STORE_KEY = "connections";

export const SSH_KEYRING_SERVICE = "zedcode-ssh";
 ...
 *   handshake.
 * - `agent`: the local ssh-agent signs the handshake. ZedCode never sees, stores or
...
const CHANGED_EVENT = "zedcode://ssh-connections-changed";
