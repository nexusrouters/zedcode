    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <SettingRow
          ...
          description="Alert when Claude Code or Codex running in a terminal needs your input or finishes. Desktop notification when ZedCode is unfocused, in-app otherwise."
        >
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          <SettingRow
            ...
            description="Open ZedCode automatically when you sign in."
          >
            <Switch
              checked={autostart}
...
function notificationTestTitle(status: NotificationTestState): string {
  switch (status) {
    ...
    case "failed":
      return "ZedCode could not request a native notification";
    default:
