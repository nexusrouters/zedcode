    ...
    <div className="flex flex-col gap-7">
      ...
      <section className="flex flex-col gap-2">
        ...
        <SettingRow
          ...
          description="Record each request the agent assembles — system prompt, message history, attached tools — so a failure can be read rather than guessed at. Kept in memory only, never written to disk, and cleared when ZedCode closes. Open the inspector from the icon in the AI bar."
        >
          <Switch
        ...
        <div className="-mx-2 max-h-[calc(100vh-14rem)] overflow-y-auto px-2 flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1">
            ...
            <Textarea
              ...
              placeholder="Persona & rules. Appended to ZedCode's core system prompt."
