...
Start ZedCode locally, then run:
...
measure, then return to the terminal and press Enter. Use ZedCode normally
...
bun run profile:browser -- --output /tmp/zedcode-profile
