...
export const IDLE_PROBE_GLOBAL = "__zedcodeIdleProbe"

const probeFactory = function installZedcodeIdleProbe(globalName, stackCaptureBudget) {
  ...
  const siteFromStack = (kind) => {
    ...
    for (const line of lines) {
      ...
      if (line.includes("installZedcodeIdleProbe")) continue
