...
class BridgeViewController: CAPBridgeViewController {
    ...
    override func capacitorDidLoad() {
        ...
        let source = """
        window.__ZEDCODE_APNS_ENV__ = '\(apnsEnvironment)';
        window.__ZEDCODE_HARDWARE_KEYBOARD__ = \(attached ? "true" : "false");
        """
    ...
    private func publishHardwareKeyboardState(_ attached: Bool) {
        ...
        window.__ZEDCODE_HARDWARE_KEYBOARD__ = \(value);
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private static let widgetAppGroup = "group.com.zedcode.app"
    private static let widgetSnapshotKey = "widgetSnapshot"

    /// Pulls the session overview JSON from the web layer (window.__ZEDCODE_WIDGET_SNAPSHOT__),
    ...
    private func writeWidgetSnapshot() {
        ...
        let js = "(typeof window.__ZEDCODE_WIDGET_SNAPSHOT__ === 'function') ? window.__ZEDCODE_WIDGET_SNAPSHOT__() : null"
