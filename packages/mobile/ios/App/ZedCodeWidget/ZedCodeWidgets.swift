...
struct OverviewWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("ZedCode")
...
@main
struct ZedCodeWidgetBundle: WidgetBundle {
