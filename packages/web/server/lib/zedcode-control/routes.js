...
export const registerZedCodeControlRoutes = (app, { controlService }) => {
  app.post('/api/zedcode/control', express.json({ limit: '1mb' }), async (req, res) => {
    ...
    try {
      ...
      const controlError = asControlError(error, 'ZedCode control action failed');
