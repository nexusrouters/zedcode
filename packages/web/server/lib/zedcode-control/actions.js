 ...
 */
export const ZEDCODE_CONTROL_ACTION_DEFINITIONS = Object.freeze([
...
const ZEDCODE_CONTROL_ACTIONS = Object.freeze(
  ZEDCODE_CONTROL_ACTION_DEFINITIONS.map(({ action }) => action),
);

export const ZEDCODE_AGENT_TOOL_ACTION_DEFINITIONS = Object.freeze(
  ZEDCODE_CONTROL_ACTION_DEFINITIONS.filter(({ agentExposed }) => agentExposed !== false),
);

export const ZEDCODE_AGENT_TOOL_ACTIONS = Object.freeze(
  ZEDCODE_AGENT_TOOL_ACTION_DEFINITIONS.map(({ action }) => action),
);

export const ZEDCODE_WEB_ACTION_DEFINITIONS = Object.freeze([
...
export const ZEDCODE_WEB_ACTIONS = Object.freeze(
  ZEDCODE_WEB_ACTION_DEFINITIONS.map(({ action }) => action),
);

/** Everything the callback route will dispatch, whichever tool asked. */
export const ZEDCODE_ALL_ACTIONS = Object.freeze([
  ...ZEDCODE_CONTROL_ACTIONS,
  ...ZEDCODE_WEB_ACTIONS,
]);
