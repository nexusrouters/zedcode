...
## El comando ZedCode se cierra o no arranca

- confirma que Node.js es `>=22`
- ejecuta `zedcode --version`
- reinstala la última CLI si hace falta

## No se puede acceder a la UI web

- revisa los logs del servidor con `zedcode logs`
...
- confirma que el servidor de ZedCode está en marcha
