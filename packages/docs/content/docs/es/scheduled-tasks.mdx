...
Las tareas solo se disparan mientras el servidor de ZedCode está en funcionamiento. Si lo cierras, las ejecuciones programadas se pausan hasta que vuelva a estar activo.
