---
title: Schnellstart
description: Starte ZedCode schnell und wähle die richtige App für die Aufgabe.
---
...
2. Installiere das ZedCode-CLI (siehe [Installieren](/install/) für den Einzeilenbefehl).
3. Führe `zedcode --ui-password be-creative-here` aus.
...
Du solltest die ZedCode-Session-Liste in deinem Browser sehen. Wenn sie geladen wird, bist du startklar.
