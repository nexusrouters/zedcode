...
Die Desktop-App kann unter **Settings → ZedCode → Tunnel** einen öffentlichen Tunnel erstellen. Für diesen Weg musst du ZedCode nicht per CLI starten.

## Anbieter installieren

ZedCode startet das Provider-CLI auf deinem Rechner. Installiere zuerst den Anbieter, den du verwenden möchtest:
...
1. Öffne **Settings → ZedCode → Tunnel**.
