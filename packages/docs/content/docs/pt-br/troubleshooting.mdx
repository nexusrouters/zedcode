...
## O comando ZedCode encerra ou não inicia

- confirme o Node.js `>=22`
- execute `zedcode --version`
- reinstale a CLI mais recente se necessário

## A UI web não está acessível

- verifique os logs do servidor com `zedcode logs`
...
- confirme que o servidor do ZedCode está em execução
