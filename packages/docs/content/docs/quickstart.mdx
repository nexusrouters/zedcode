---
title: Quickstart
description: Start ZedCode quickly and pick the right app for the task.
---
...
2. Install the ZedCode CLI (see [Install](/install/) for the one-line command).
...
You should see the ZedCode session list in your browser. If it loads, you're up and running.
