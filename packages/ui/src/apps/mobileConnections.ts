...
const MOBILE_CONNECTIONS_STORAGE_KEY = 'zedcode.mobile.connections.v1';
const MOBILE_SECURE_STORAGE_PREFIX = 'zedcode.mobile.';
const MOBILE_DEVICE_ID_STORAGE_KEY = 'zedcode.mobile.deviceId';
  ...
  const redeemPairingConnection = React.useCallback(async (payload: PairingConnectionPayload) => {
    ...
    try {
      ...
      const redeemBody = JSON.stringify({
        ...
        clientLabel: 'ZedCode Mobile',
        clientKind: 'mobile',
        deviceName: 'ZedCode Mobile',
  ...
  const submitPassword = React.useCallback(async (password: string) => {
    ...
    try {
      ...
      const loginInit = {
        ...
        body: JSON.stringify({ password, trustDevice: true, issueClientToken: true, clientLabel: 'ZedCode Mobile', clientKind: 'mobile', devicePlatform: mobileDevicePlatform(), dedupeKey: mobileClientDedupeKey() }),
      };
