  ...
  switch (variant) {
    ...
    case 'remote-wrong-service': {
      ...
      return {
        ...
        description: `The server at "${host || 'unknown'}" is not running ZedCode. Verify the address points to an ZedCode server.`,
    ...
    case 'remote-incompatible': {
      ...
      return {
        ...
        description: `The ZedCode server at "${host || 'unknown'}" is not compatible with this app version. Update ZedCode on the server, then try again.`,
