...
const ChatInputComponent: React.FC<ChatInputProps> = ({ onOpenSettings, scrollToBottom, active = true }) => {
    ...
    const handleDragEnter = (e: React.DragEvent) => {
        ...
        const isInternal = e.dataTransfer.types?.includes('application/x-zedcode-file-path') ?? false;
    ...
    const handleDrop = async (e: React.DragEvent) => {
        ...
        const internalPath = e.dataTransfer.getData('application/x-zedcode-file-path');
    ...
    const toggleDictation = React.useCallback(() => {
        window.dispatchEvent(new CustomEvent('zedcode:dictation-toggle'));
    }, []);
