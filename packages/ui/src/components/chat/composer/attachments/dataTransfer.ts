 ...
 * payloads must be parsed for paths, and ZedCode's own file tree marks an
...
/** Data type marking a drag that started in ZedCode's own file tree. */
export const INTERNAL_FILE_PATH_TYPE = 'application/x-zedcode-file-path';
