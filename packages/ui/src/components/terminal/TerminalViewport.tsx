...
// mounts (see the `__zedcodeEnsureNerdFonts` hook in index.html). Wait for
...
const ensureNerdFonts = (): Promise<void> => {
  ...
  const loader = (window as typeof window & { __zedcodeEnsureNerdFonts?: () => Promise<void> }).__zedcodeEnsureNerdFonts;
