...
export const ComposerDictation: React.FC<ComposerDictationProps> = ({
    ...
    // The dictation server (WebSocket + STT worker) lives in the ZedCode
    ...
    React.useEffect(() => {
        ...
        window.addEventListener('zedcode:dictation-toggle', onToggle);
        return () => window.removeEventListener('zedcode:dictation-toggle', onToggle);
