...
export const PluginsSidebar: React.FC<PluginsSidebarProps> = ({
  ...
  React.useEffect(() => {
    ...
    window.addEventListener('zedcode:settings-open-plugin-add', handleOpenAdd);
    return () => window.removeEventListener('zedcode:settings-open-plugin-add', handleOpenAdd);
  }, []);
