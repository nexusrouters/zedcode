...
export const GitSettings: React.FC = () => {
  ...
  const viewOptions = React.useMemo(
    () => [
      { id: 'flat' as const, label: t('settings.zedcode.git.option.flatList') },
      { id: 'tree' as const, label: t('settings.zedcode.git.option.treeView') },
    ],
    [t]
  );
  ...
  return (
    <SettingsSection title={t('settings.zedcode.git.title')}>
      <div className={SETTINGS_OPTION_STACK_CLASS}>
        <SettingsControlGroup
          settingsItem="git.changes-view"
          title={t('settings.zedcode.git.changesViewTitle')}
        >
          <SettingsRadioGroup aria-label={t('settings.zedcode.git.changesViewAria')}>
            {viewOptions.map((option) => (
              <SettingsRadioOption
                ...
                label={option.label}
                ariaLabel={t('settings.zedcode.git.optionAria', { option: option.label })}
              />
            ))}
          </SettingsRadioGroup>
        </SettingsControlGroup>
        ...
        <SettingsCheckboxRow
          ...
          label={t('settings.zedcode.git.enableGitmoji')}
          ariaLabel={t('settings.zedcode.git.enableGitmojiAria')}
        />
        ...
        <SettingsCheckboxRow
          ...
          label={t('settings.zedcode.git.showGitignored')}
          ariaLabel={t('settings.zedcode.git.showGitignoredAria')}
        />
      </div>
    </SettingsSection>
  );
