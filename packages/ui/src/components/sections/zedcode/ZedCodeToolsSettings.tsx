...
/**
 * Which ZedCode capabilities agents are given.
 *
 ...
 */
export const ZedCodeToolsSettings: React.FC = () => {
  const { t } = useI18n();
  ...
  return (
    <SettingsSection title={t('settings.zedcode.tools.title')}>
      <div className={SETTINGS_OPTION_STACK_CLASS}>
        <SettingsCheckboxRow
          settingsItem="sessions.agent-control-tool"
          checked={agentControlToolEnabled}
          onChange={handleAgentControlToolChange}
          label={t('settings.zedcode.tools.field.agentControlTool')}
          ariaLabel={t('settings.zedcode.tools.field.agentControlToolAria')}
          info={t('settings.zedcode.tools.field.agentControlToolInfo')}
        />
        ...
        <SettingsCheckboxRow
          ...
          label={t('settings.zedcode.tools.field.agentWebTool')}
          ariaLabel={t('settings.zedcode.tools.field.agentWebToolAria')}
          info={t('settings.zedcode.tools.field.agentWebToolInfo')}
        />
      </div>
    </SettingsSection>
  );
