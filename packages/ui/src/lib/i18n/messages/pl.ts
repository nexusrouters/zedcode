...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj ZedCode, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'ZedCode został zainstalowany',
  ...
  'mobile.connect.welcome.title': 'Połącz z ZedCode',
  ...
  'mobile.connect.password.placeholder': 'Hasło ZedCode',
  ...
  'mobile.connect.scan.invalid': 'Ten kod QR nie jest kodem połączenia ZedCode.',
  ...
  'mobile.connect.relay.badge': 'przez ZedCode Relay',
  ...
  'mobile.connect.error.unreachable': 'Nie udało się połączyć z tym serwerem ZedCode.',
  ...
  'sessions.sidebar.footer.actions.aboutZedCode': 'O ZedCode',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia ZedCode.',
  ...
  'onboarding.chooser.title': 'Witaj w ZedCode',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli ZedCode nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień ZedCode i przeładowuje konfigurację OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera ZedCode aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer ZedCode, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji ZedCode. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia ZedCode, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj ZedCode na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim ZedCode. Zweryfikuj czy adres wskazuje na serwer ZedCode.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia ZedCode. Zweryfikuj czy adres wskazuje na serwer ZedCode.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer ZedCode pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj ZedCode na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'ZedCode nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan ZedCode, kondycję OpenCode, katalogi i projekty.',
  ...
  'aboutDialog.zedCodeVersionLabel': 'Wersja ZedCode {version}',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'Serwer ZedCode, z którym połączona jest ta aplikacja, nie odpowiedział na API walkthroughu — jest więc starszy niż aplikacja. Zaktualizuj serwer do wersji 1.18 lub nowszej i odśwież.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} działa na maszynie, na której jest ZedCode, i nie udało się otworzyć do niej połączenia. Nic z twojej własnej maszyny nie jest tu pokazywane.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Działają na komputerze, na którym uruchomiony jest ZedCode. Do ich otwarcia potrzebna jest aplikacja desktopowa.',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do ZedCode — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami ZedCode',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'ZedCode potrzebuje dostępu do tego folderu.',
  ...
  'filesView.editor.binaryFileDescription': 'Ten plik jest binarny i nie można go edytować w ZedCode. Pobierz go, aby otworzyć w innej aplikacji.',
  ...
  'header.actions.openAppMenu': 'Menu ZedCode',
  'header.actions.openAppMenuAria': 'Otwórz menu ZedCode',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po ZedCode.',
  ...
  'zedCodeLogo.aria.logo': 'Logo ZedCode',
  ...
  'sessionAuth.error.networkDescription': 'Nie udało się zweryfikować sesji UI. Jeśli otwierasz ZedCode z innego urządzenia w sieci lokalnej, włącz Desktop Network Access w aplikacji desktopowej i użyj adresu LAN widocznego w Ustawieniach.',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj ZedCode',
  ...
  'updateDialog.error.takingLonger': 'Aktualizacja trwa dłużej niż oczekiwano. Poczekaj chwilę i odśwież albo uruchom: zedcode update',
  'updateDialog.error.updateFailed': 'Aktualizacja nie powiodła się',
  'mobileUpdate.toast.available.title': 'Dostępna aktualizacja ZedCode',
  ...
  'updateDialog.header.updating': 'Aktualizowanie ZedCode...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw ZedCode otwarte.',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce ZedCode — zainstaluj je, aby zacząć.',
  ...
  'settings.zedcode.keyboardShortcuts.action.open_timeline_dialog.label': 'Otwórz oś czasu',
  ...
  'settings.zedcode.visual.field.mobileKeyboardModeAria': 'Tryb klawiatury mobilnej',
  'settings.zedcode.visual.field.selectMobileKeyboardModePlaceholder': 'Wybierz tryb klawiatury mobilnej',
  'settings.zedcode.visual.actions.resetMobileKeyboardModeAria': 'Resetuj tryb klawiatury mobilnej',
  'settings.zedcode.visual.option.mobileKeyboardMode.native.label': 'Natywny',
  'settings.zedcode.visual.option.mobileKeyboardMode.native.description': 'Użyj domyślnego zachowania przeglądarki/systemu.',
  'settings.zedcode.visual.option.mobileKeyboardMode.resizeContent.label': 'Zmień rozmiar zawartości',
  'settings.zedcode.visual.option.mobileKeyboardMode.resizeContent.description': 'Dopasuj układ tak, aby zawartość pozostała widoczna ponad klawiaturą.',
