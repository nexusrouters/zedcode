...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instala ZedCode para acceder más rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Descartar",
  "pwa.installPrompt.started": "Instalación iniciada",
  "pwa.installPrompt.installed": "ZedCode se instaló",
  ...
  "mobile.connect.welcome.title": "Conéctate a ZedCode",
  ...
  "mobile.connect.password.placeholder": "Contraseña de ZedCode",
  ...
  "mobile.connect.scan.invalid": "Ese código QR no es un código de conexión de ZedCode.",
  ...
  "mobile.connect.relay.badge": "a través de ZedCode Relay",
  ...
  "mobile.connect.error.unreachable": "No se pudo conectar con ese servidor de ZedCode.",
  ...
  "sessions.sidebar.footer.actions.aboutZedCode": "Acerca de ZedCode",
  ...
  "walkthrough.blocked.serverUnsupported.description": "El servidor de ZedCode al que está conectada esta app no respondió a la API de walkthrough, así que es más antiguo que la app. Actualiza el servidor a 1.18 o posterior y vuelve a intentarlo.",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} se ejecuta en la máquina donde está ZedCode y no se pudo abrir la conexión con ella. Aquí no se muestra nada de tu propia máquina.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Se ejecutan en la máquina que aloja ZedCode. Abrirlos requiere la aplicación de escritorio.",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a ZedCode: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "filesView.editor.binaryFileDescription": "Este archivo es binario y no se puede editar en ZedCode. Descárgalo para abrirlo con otra aplicación.",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "ZedCode necesita acceso a esta carpeta.",
  ...
  "aboutDialog.zedCodeVersionLabel": "Versión de ZedCode {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de ZedCode, el estado de OpenCode, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por ZedCode de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de ZedCode",
  "header.actions.openAppMenuAria": "Abrir menú de ZedCode",
  ...
  "sessionAuth.error.networkDescription": "No pudimos verificar la sesión de la UI. Si abres ZedCode desde otro dispositivo en tu red local, activa Desktop Network Access en la app de escritorio y usa la dirección LAN que aparece en Ajustes.",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear ZedCode",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de ZedCode",
  ...
  "multiRun.window.description": "Ventana de ZedCode Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a ZedCode",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si ZedCode no detecta OpenCode automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "OpenCode es el corazón de ZedCode. Instálalo para empezar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de ZedCode y recarga la configuración de OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de ZedCode para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor ZedCode o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de ZedCode. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta ZedCode pero no es compatible con esta versión de la app. Actualiza ZedCode en el servidor y vuelve a intentarlo.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando ZedCode. Verifica que la dirección apunte a un servidor ZedCode.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando ZedCode. Verifica que la dirección apunte a un servidor ZedCode.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  "onboarding.desktopRecovery.remoteIncompatible.description": "El servidor ZedCode en \"{host}\" no es compatible con esta versión de la app. Actualiza ZedCode en el servidor y vuelve a intentarlo.",
  ...
  "startup.initRecovery.description": "ZedCode no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando ZedCode...",
  ...
  "updateDialog.error.takingLonger": "La actualización está tardando más de lo esperado. Espera un poco y refresca, o ejecuta: zedcode update",
  "mobileUpdate.toast.available.title": "Actualización de ZedCode disponible",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantén ZedCode abierto.",
  ...
  "zedCodeLogo.aria.logo": "Logo de ZedCode",
