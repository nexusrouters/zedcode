...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copy the workspace ID from the dashboard URL and the auth cookie from your browser developer tools. ZedCode never scans browser cookie storage.',
  ...
  'settings.window.description': 'ZedCode settings window.',
  ...
  'settings.page.appearance.description': 'Customize how ZedCode looks and feels.',
  ...
  'settings.zedcode.tunnel.title': 'External Tunnel',
  'settings.zedcode.tunnel.description': 'Configure secure remote access with quick links or your own managed remote Cloudflare tunnel.',
  'settings.zedcode.tunnel.note.serverSideEnforced': 'Secure tunnel access is enforced server-side.',
  'settings.zedcode.tunnel.note.connectLinksOneTime': 'Connect links are one-time and are revoked when tunnel stops or connect-link TTL expires.',
  'settings.zedcode.tunnel.note.cloudflareConnectorTarget': 'Cloudflare connector target:',
  'settings.zedcode.tunnel.note.cloudflareConnectorTargetUse': 'For Cloudflare connector target, use',
  'settings.zedcode.tunnel.note.tokensSavedPerTunnel': 'Tokens are saved per tunnel and reused from disk.',
  'settings.zedcode.tunnel.note.customConfigUsed': 'Custom config file will be used when starting the tunnel.',
  'settings.zedcode.tunnel.note.defaultConfigUsed': 'When empty, cloudflared uses its default config (~/.cloudflared/config.yml).',
  'settings.zedcode.tunnel.note.managedRemoteRequiresDomain': 'Managed remote tunnels require a purchased domain in your Cloudflare account.',
  'settings.zedcode.tunnel.note.managedLocalUsesConfig': 'Managed local tunnels use your local cloudflared configuration file.',
  'settings.zedcode.tunnel.note.startModeAndGenerateLink': 'Start a {mode} tunnel and generate a one-time connect link. Do not close the app while this tunnel is in use.',
  'settings.zedcode.tunnel.note.scanQrToConnect': 'Scan with your phone to connect.',
  'settings.zedcode.tunnel.section.redeemedAccessLinks': 'Redeemed access links',
  'settings.zedcode.tunnel.section.savedManagedRemoteTunnels': 'Saved managed remote tunnels',
  'settings.zedcode.tunnel.notAvailable.cloudflaredNotFound': 'cloudflared not found',
  'settings.zedcode.tunnel.notAvailable.dependencyNotFound': '{dependency} was not found.',
  'settings.zedcode.tunnel.notAvailable.installHint': 'Install it to enable remote tunnel access:',
  'settings.zedcode.tunnel.field.provider': 'Provider',
  'settings.zedcode.tunnel.field.providerPlaceholder': 'Select provider',
  'settings.zedcode.tunnel.field.tunnelType': 'Tunnel type',
  'settings.zedcode.tunnel.field.connectLinkTtl': 'Connect link TTL',
  'settings.zedcode.tunnel.field.tunnelSessionTtl': 'Tunnel session TTL',
  'settings.zedcode.tunnel.field.hostnameLabel': 'Hostname:',
  'settings.zedcode.tunnel.field.savedTokenAvailablePlaceholder': 'Saved token available (optional to replace)',
  'settings.zedcode.tunnel.field.pasteTokenPlaceholder': 'Paste token for this tunnel',
  'settings.zedcode.tunnel.field.newPresetNamePlaceholder': 'Tunnel name (e.g. Production)',
  'settings.zedcode.tunnel.field.newPresetHostnamePlaceholder': 'Hostname (e.g. oc.example.com)',
  'settings.zedcode.tunnel.field.newPresetTokenPlaceholder': 'Token',
  'settings.zedcode.tunnel.field.managedRemoteTokenInfoAria': 'Managed remote tunnel token info',
  'settings.zedcode.tunnel.field.configurationFile': 'Configuration file',
  'settings.zedcode.tunnel.field.configurationFilePlaceholder': 'Using default cloudflared config',
  'settings.zedcode.tunnel.field.managedRemoteTunnelToConnect': 'Managed remote tunnel to connect',
  'settings.zedcode.tunnel.field.selectSavedTunnelPlaceholder': 'Select saved tunnel',
  'settings.zedcode.tunnel.field.publicUrlHint': 'Public URL (not accessible without a token)',
  'settings.zedcode.tunnel.field.connectLink': 'Connect link',
  'settings.zedcode.tunnel.field.expires': 'Expires',
  'settings.zedcode.tunnel.field.connectQrAlt': 'Tunnel connect QR code',
  'settings.zedcode.tunnel.actions.removePresetAria': 'Remove {name}',
  'settings.zedcode.tunnel.actions.saveToken': 'Save token',
  'settings.zedcode.tunnel.actions.browseConfigFileAria': 'Browse config file',
  'settings.zedcode.tunnel.actions.clearConfigFileAria': 'Clear config file',
  'settings.zedcode.tunnel.actions.openManagedRemoteDocs': 'Check documentation on how to configure a managed remote tunnel',
  'settings.zedcode.tunnel.actions.openManagedLocalDocs': 'Check documentation on managed local tunnel configuration',
  'settings.zedcode.tunnel.actions.startTunnel': 'Start Tunnel',
  'settings.zedcode.tunnel.actions.startingTunnel': 'Starting tunnel...',
  'settings.zedcode.tunnel.actions.stopTunnel': 'Stop Tunnel',
  'settings.zedcode.tunnel.actions.stopping': 'Stopping...',
  'settings.zedcode.tunnel.actions.newConnectLink': 'New connect link',
  'settings.zedcode.tunnel.actions.copied': 'Copied',
  'settings.zedcode.tunnel.actions.retry': 'Retry',
  'settings.zedcode.tunnel.option.moreProvidersSoon': 'More providers coming soon',
  'settings.zedcode.tunnel.option.mode.quick.label': 'Quick',
  'settings.zedcode.tunnel.option.mode.quick.tooltip': 'Quick Tunnel is best effort and uptime is not guaranteed.',
  'settings.zedcode.tunnel.option.mode.managedRemote.label': 'Managed Remote',
  'settings.zedcode.tunnel.option.mode.managedRemote.tooltip': 'Managed Remote uses your Cloudflare account and hostname for long-lived access.',
  'settings.zedcode.tunnel.option.mode.managedLocal.label': 'Managed Local',
  'settings.zedcode.tunnel.option.mode.managedLocal.tooltip': 'Managed Local uses your local cloudflared configuration file.',
  'settings.zedcode.tunnel.warning.quickModeReliability': 'For more reliable long-lived access, switch to Managed Remote or Managed Local tunnel mode.',
  'settings.zedcode.tunnel.warning.replacesActiveTunnel': 'Starting this tunnel replaces the active tunnel and revokes existing connect links and remote sessions.',
  ...
  'settings.zedcode.tunnel.state.loading': 'Loading',
  'settings.zedcode.tunnel.state.expired': 'Expired',
  'settings.zedcode.tunnel.state.revoked': 'Revoked',
  'settings.zedcode.tunnel.state.inactive': 'Inactive',
  'settings.zedcode.tunnel.state.noExpiry': 'No expiry',
  'settings.zedcode.tunnel.state.never': 'Never',
  'settings.zedcode.tunnel.state.tunnelReady': 'Tunnel ready',
  'settings.zedcode.tunnel.session.redeemedAt': 'Redeemed {time}',
  'settings.zedcode.tunnel.session.expiresIn': 'Expires in {remaining}',
  'settings.zedcode.tunnel.session.inactiveWithReason': 'Inactive ({reason})',
  'settings.zedcode.tunnel.error.invalidConfigExtension': 'Config file must use .yml, .yaml, or .json extension.',
  'settings.zedcode.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/zedcode/cloudflare-managed-remote-tunnels.json.',
  'settings.zedcode.tunnel.empty.noManagedRemoteTunnels': 'No managed remote tunnels saved yet.',
  'settings.zedcode.tunnel.toast.checkAvailabilityFailed': 'Failed to check tunnel availability',
  'settings.zedcode.tunnel.toast.saveSettingsFailed': 'Failed to save tunnel settings',
  'settings.zedcode.tunnel.toast.saveTtlFailed': 'Failed to save tunnel TTL settings',
  'settings.zedcode.tunnel.toast.saveTokenFailed': 'Failed to save managed remote tunnel token',
  'settings.zedcode.tunnel.toast.selectOrAddManagedRemoteFirst': 'Select or add a managed remote tunnel first',
  'settings.zedcode.tunnel.toast.managedRemoteTokenRequiredBeforeStarting': 'Managed remote tunnel token is required before starting',
  'settings.zedcode.tunnel.toast.addManagedRemoteTokenBeforeStarting': 'Add a managed remote tunnel token before starting',
  'settings.zedcode.tunnel.toast.startFailed': 'Failed to start tunnel',
  'settings.zedcode.tunnel.toast.startedButNoPublicUrl': 'Tunnel started but no public URL was returned',
  'settings.zedcode.tunnel.toast.replacedTunnelSingleSingle': 'Replaced previous tunnel: revoked 1 link, invalidated 1 session.',
  'settings.zedcode.tunnel.toast.replacedTunnelSingleManySessions': 'Replaced previous tunnel: revoked 1 link, invalidated {invalidatedSessionCount} sessions.',
  'settings.zedcode.tunnel.toast.replacedTunnelManyLinksSingleSession': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated 1 session.',
  'settings.zedcode.tunnel.toast.replacedTunnelManyMany': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated {invalidatedSessionCount} sessions.',
  'settings.zedcode.tunnel.toast.linkReady': 'Tunnel link ready',
  'settings.zedcode.tunnel.toast.stopped': 'Tunnel stopped',
  'settings.zedcode.tunnel.toast.stopFailed': 'Failed to stop tunnel',
  'settings.zedcode.tunnel.toast.connectLinkCopied': 'Connect link copied',
  'settings.zedcode.tunnel.toast.copyUrlFailed': 'Failed to copy URL',
  'settings.zedcode.tunnel.toast.saveSelectedManagedRemoteFailed': 'Failed to save selected managed remote tunnel',
  'settings.zedcode.tunnel.toast.tunnelNameRequired': 'Tunnel name is required',
  'settings.zedcode.tunnel.toast.managedRemoteHostnameRequired': 'Managed remote tunnel hostname is required',
  'settings.zedcode.tunnel.toast.managedRemoteTokenRequired': 'Managed remote tunnel token is required',
  'settings.zedcode.tunnel.toast.hostnameAlreadyExists': 'This hostname already exists',
  'settings.zedcode.tunnel.toast.managedRemoteSaved': 'Managed remote tunnel saved',
  'settings.zedcode.tunnel.toast.managedRemoteRemoved': 'Managed remote tunnel removed',
  ...
  'settings.remoteInstances.direct.title': 'Other ZedCode servers',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Add another ZedCode server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another ZedCode server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid ZedCode connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so ZedCode Desktop can connect to this server.',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': 'Scan this with the ZedCode app on your other device. It is single-use and expires.',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Works at home and away. Away traffic goes through ZedCode Private Relay — an end-to-end encrypted tunnel. No setup needed.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Scan this QR code with the ZedCode app on your other device.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether ZedCode should start the server for you, or connect to one that is already running.',
  ...
  'settings.zedcode.about.title': 'About ZedCode',
  'settings.zedcode.about.field.version': 'Version',
  'settings.zedcode.about.field.openCodeVersion': 'OpenCode version',
  'settings.zedcode.about.field.instanceUrls': 'Instance URLs',
  'settings.zedcode.about.field.applicationUrl': 'Application',
  'settings.zedcode.about.field.tunnelUrl': 'Tunnel',
  'settings.zedcode.about.state.checking': 'Checking...',
  'settings.zedcode.about.state.upToDate': 'Up to date',
  'settings.zedcode.about.state.unknown': 'unknown',
  'settings.zedcode.about.actions.checkUpdates': 'Check updates',
  'settings.zedcode.about.actions.update': 'Update',
  'settings.zedcode.about.actions.updateToVersion': 'Update to {version}',
  'settings.zedcode.about.actions.checkForUpdates': 'Check for updates',
  'settings.zedcode.about.toast.latestVersion': 'You are on the latest version',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. ZedCode will scan it for folders containing',
  ...
  'settings.zedcode.passkeys.field.currentDevice': 'Current device',
  'settings.zedcode.passkeys.actions.add': 'Add passkey',
  'settings.zedcode.passkeys.actions.cancelSetup': 'Cancel passkey setup',
  'settings.zedcode.passkeys.actions.signOutEverywhere': 'Sign out everywhere',
  'settings.zedcode.passkeys.actions.signingOut': 'Signing out…',
  'settings.zedcode.passkeys.actions.removing': 'Removing…',
  'settings.zedcode.passkeys.state.uiPasswordRequired': 'Passkeys are available only when the UI password lock is enabled.',
  'settings.zedcode.passkeys.state.loading': 'Loading passkeys…',
  'settings.zedcode.passkeys.state.noneSaved': 'No passkeys saved for this host yet.',
  'settings.zedcode.passkeys.item.lastUsed': 'Last used {time}',
  'settings.zedcode.passkeys.item.added': 'Added {time}',
  'settings.zedcode.passkeys.time.neverUsed': 'Never used',
  'settings.zedcode.passkeys.toast.loadFailed': 'Could not load passkeys.',
  'settings.zedcode.passkeys.toast.enableUiPasswordFirst': 'Enable the UI password lock before adding passkeys.',
  'settings.zedcode.passkeys.toast.added': 'Passkey added',
  'settings.zedcode.passkeys.toast.setupCanceled': 'Passkey setup canceled',
  'settings.zedcode.passkeys.toast.addFailed': 'Could not add passkey.',
  'settings.zedcode.passkeys.toast.removed': 'Passkey removed',
  'settings.zedcode.passkeys.toast.removeFailed': 'Could not remove passkey.',
  'settings.zedcode.passkeys.toast.clearAuthFailed': 'Could not clear saved authentication.',
  'settings.zedcode.sessionRetention.title': 'Session Retention',
  'settings.zedcode.sessionRetention.tooltip': 'Automatically archive or delete inactive sessions based on last activity. Keeps the 5 most recent sessions.',
  'settings.zedcode.sessionRetention.field.enableAutoCleanupAria': 'Enable auto-cleanup',
  'settings.zedcode.sessionRetention.field.enableAutoCleanup': 'Enable Auto-Cleanup',
  'settings.zedcode.sessionRetention.field.retentionPeriod': 'Retention Period',
  'settings.zedcode.sessionRetention.field.retentionPeriodAria': 'Retention period in days',
  'settings.zedcode.sessionRetention.field.days': 'days',
  'settings.zedcode.sessionRetention.field.whenSessionsExpire': 'When sessions expire',
  'settings.zedcode.sessionRetention.actions.resetRetentionAria': 'Reset retention period',
  'settings.zedcode.sessionRetention.actions.runCleanupNow': 'Run cleanup now',
  'settings.zedcode.sessionRetention.actions.cleaningUp': 'Cleaning up...',
  'settings.zedcode.sessionRetention.action.archive': 'Archive',
  'settings.zedcode.sessionRetention.action.delete': 'Delete',
  'settings.zedcode.sessionRetention.manualCleanup.title': 'Manual Cleanup',
  'settings.zedcode.sessionRetention.manualCleanup.eligibleArchiveNow': 'Eligible for archiving right now: {count}',
  'settings.zedcode.sessionRetention.manualCleanup.eligibleDeleteNow': 'Eligible for deletion right now: {count}',
  'settings.zedcode.sessionRetention.toast.noneEligibleArchive': 'No sessions eligible for archiving',
  'settings.zedcode.sessionRetention.toast.noneEligibleDelete': 'No sessions eligible for deletion',
  'settings.zedcode.sessionRetention.toast.archivedCount': 'Archived {count} session(s)',
  'settings.zedcode.sessionRetention.toast.deletedCount': 'Deleted {count} session(s)',
  'settings.zedcode.sessionRetention.toast.failedArchiveCount': 'Failed to archive {count} session(s)',
  'settings.zedcode.sessionRetention.toast.failedDeleteCount': 'Failed to delete {count} session(s)',
  'settings.zedcode.desktopNetwork.title': 'Desktop Network Access',
  'settings.zedcode.desktopNetwork.field.windowControlsPosition': 'Window controls position',
  'settings.zedcode.desktopNetwork.field.windowControlsPositionDescription': 'Choose where minimize, maximize, and close buttons appear. Defaults to the right.',
  'settings.zedcode.desktopNetwork.field.windowControlsPositionAria': 'Window controls position',
  'settings.zedcode.desktopNetwork.option.windowControlsLeft': 'Left',
  'settings.zedcode.desktopNetwork.option.windowControlsRight': 'Right',
  'settings.zedcode.desktopNetwork.field.windowControls': 'Window controls',
  'settings.zedcode.desktopNetwork.field.windowControlsStyle': 'Style',
  'settings.zedcode.desktopNetwork.field.windowControlsStyleAria': 'Window controls style',
  'settings.zedcode.desktopNetwork.option.windowControlsClassic': 'Classic',
  'settings.zedcode.desktopNetwork.option.windowControlsTrafficLights': 'Traffic lights',
  'settings.zedcode.desktopNetwork.field.launchAtLoginAria': 'Start ZedCode at login',
  'settings.zedcode.desktopNetwork.field.launchAtLogin': 'Start ZedCode when you log in',
  'settings.zedcode.desktopNetwork.field.launchAtLoginDescription': 'Starts the app in the background without opening a window. Use the desktop status icon to open it.',
  'settings.zedcode.desktopNetwork.field.macMenuBarAria': 'Show ZedCode in the macOS menu bar',
  'settings.zedcode.desktopNetwork.field.macMenuBar': 'Show ZedCode in the menu bar',
  'settings.zedcode.desktopNetwork.field.macMenuBarDescription': 'Requires an app restart. When off, ZedCode does not create the menu bar item or run its session, approval, and usage updates.',
  'settings.zedcode.desktopNetwork.field.minimizeToTrayAria': 'Close ZedCode to the system tray',
  'settings.zedcode.desktopNetwork.field.minimizeToTray': 'Close to the system tray',
  'settings.zedcode.desktopNetwork.field.minimizeToTrayDescription': 'Keeps ZedCode running in the system tray when the main window is closed. Minimizing still leaves the window in the taskbar.',
  'settings.zedcode.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while ZedCode is running',
  'settings.zedcode.desktopNetwork.field.keepAwake': 'Keep computer awake while ZedCode is running',
  'settings.zedcode.desktopNetwork.field.keepAwakeDescription': 'Prevents system sleep so phones can keep reaching this app. The screen can still turn off.',
  'settings.zedcode.desktopNetwork.field.allowLanAccessAria': 'Allow LAN access to desktop sidecar',
  'settings.zedcode.desktopNetwork.field.allowLanAccess': 'Let other devices on your local network open this app',
  'settings.zedcode.desktopNetwork.field.allowLanAccessDescription': 'Restarts the app so phones, tablets, and other computers on your Wi-Fi can open it.',
  'settings.zedcode.desktopNetwork.field.warning': 'Warning: while enabled, the app is reachable by anyone on the same local network.',
  'settings.zedcode.desktopNetwork.field.passwordRequiredWarning': 'LAN access requires a Desktop UI Password. Until one is set, the desktop app starts local-only.',
  'settings.zedcode.desktopPassword.actions.showPassword': 'Show password',
  'settings.zedcode.desktopPassword.actions.hidePassword': 'Hide password',
  'settings.zedcode.desktopPassword.field.password': 'Desktop UI Password',
  'settings.zedcode.desktopPassword.field.passwordPlaceholder': 'No password required',
  'settings.zedcode.desktopPassword.field.passwordDescription': 'ZedCode asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  'settings.zedcode.desktopNetwork.hint.openAfterRestart': 'After restart, open from another device: ',
  'settings.zedcode.desktopNetwork.hint.openNow': 'Open from another device: ',
  'settings.zedcode.desktopNetwork.actions.saveAndRestart': 'Save + Restart',
  'settings.zedcode.desktopNetwork.error.loadFailed': 'Failed to load desktop settings',
  'settings.zedcode.desktopNetwork.error.saveFailed': 'Failed to save desktop settings',
  'settings.zedcode.desktopNetwork.error.savedRestartFailed': 'Saved, but failed to restart app',
  'settings.zedcode.desktopNetwork.error.launchAtLoginUnsupported': 'Launch at login is not supported on this system',
  'settings.zedcode.desktopNetwork.error.launchAtLoginSaveFailed': 'Failed to update launch at login setting',
  'settings.zedcode.desktopNetwork.error.minimizeToTrayUnsupported': 'System tray background mode is not supported on this system',
  'settings.zedcode.desktopNetwork.error.minimizeToTraySaveFailed': 'Failed to update system tray setting',
  'settings.zedcode.desktopNetwork.error.keepAwakeUnsupported': 'Preventing sleep is not supported on this system',
  'settings.zedcode.desktopNetwork.error.keepAwakeSaveFailed': 'Failed to update keep awake setting',
  'settings.zedcode.opencodeCli.title': 'OpenCode CLI',
  'settings.zedcode.tools.title': 'ZedCode Tools',
  'settings.zedcode.tools.field.agentControlTool': 'Agent control tool',
  'settings.zedcode.tools.field.agentControlToolAria': 'Enable the agent control tool',
  'settings.zedcode.tools.field.agentControlToolInfo': 'Let agents orchestrate your work from chat: spin up sessions and worktrees, delegate prompts to other agents, and manage scheduled tasks. Adds a small tool description to each session. Applies after OpenCode restarts.',
  'settings.zedcode.tools.field.agentWebTool': 'ZedCode Web tool',
  'settings.zedcode.tools.field.agentWebToolAria': 'Enable the ZedCode Web tool',
  'settings.zedcode.tools.field.agentWebToolInfo': 'Let agents look at and interact with the page in ZedCode\'s browser panel: open a URL, read the page, click, type, scroll, and switch between mobile and desktop layouts. Adds a small tool description to each session. Applies after OpenCode restarts.',
  'settings.zedcode.opencodeCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.zedcode.opencodeCli.tooltipSuffix': 'binary.',
  'settings.zedcode.opencodeCli.field.binaryPath': 'OpenCode Binary Path',
  'settings.zedcode.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.zedcode.opencodeCli.field.showUpdateNotifications': 'Show OpenCode update notifications',
  'settings.zedcode.opencodeCli.field.showUpdateNotificationsAria': 'Show OpenCode update notifications',
  'settings.zedcode.opencodeCli.actions.browseAria': 'Browse for OpenCode binary path',
  'settings.zedcode.opencodeCli.actions.browse': 'Browse',
  'settings.zedcode.opencodeCli.actions.saveAndReload': 'Save + Reload',
  'settings.zedcode.opencodeCli.actions.restartingOpenCode': 'Restarting OpenCode…',
  'settings.zedcode.opencodeCli.dialog.selectBinaryTitle': 'Select opencode binary',
  'settings.zedcode.opencodeCli.tipPrefix': 'Tip: you can also use',
  'settings.zedcode.opencodeCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.zedcode.keyboardShortcuts.title': 'Keyboard Shortcuts',
  'settings.zedcode.keyboardShortcuts.actions.resetAll': 'Reset All',
  'settings.zedcode.keyboardShortcuts.actions.overwrite': 'Overwrite',
  'settings.zedcode.keyboardShortcuts.tooltip': 'Capture a new key combo, save it, and bindings will update immediately.',
  'settings.zedcode.keyboardShortcuts.overwritePrompt': 'This combo is already used by another shortcut. Overwrite and clear that other mapping?',
  'settings.zedcode.keyboardShortcuts.field.pressKeys': 'Press keys...',
  'settings.zedcode.keyboardShortcuts.error.captureFirst': 'Capture a shortcut first.',
  'settings.zedcode.keyboardShortcuts.warning.riskyBrowserShortcut': 'This shortcut can conflict with browser defaults. It is still saved.',
  'settings.zedcode.keyboardShortcuts.action.open_go_to_line.label': 'Go to line (files editor)',
  'settings.zedcode.keyboardShortcuts.action.open_command_palette.label': 'Open command palette',
  'settings.zedcode.keyboardShortcuts.action.focus_input.label': 'Focus input',
  'settings.zedcode.keyboardShortcuts.action.open_settings.label': 'Open settings',
  'settings.zedcode.keyboardShortcuts.action.toggle_terminal.label': 'Toggle terminal dock',
  'settings.zedcode.keyboardShortcuts.action.toggle_terminal_expanded.label': 'Toggle terminal expanded',
  'settings.zedcode.keyboardShortcuts.action.add_selection_to_chat.label': 'Add selection to chat',
  'settings.zedcode.keyboardShortcuts.action.toggle_sidebar.label': 'Toggle sidebar',
  'settings.zedcode.keyboardShortcuts.action.toggle_right_sidebar.label': 'Toggle context panel',
  'settings.zedcode.keyboardShortcuts.action.open_right_sidebar_git.label': 'Open Git surface',
  'settings.zedcode.keyboardShortcuts.action.open_right_sidebar_files.label': 'Open Files surface',
  'settings.zedcode.keyboardShortcuts.action.switch_context_surface.label': 'Switch context panel surface',
  'settings.zedcode.keyboardShortcuts.action.switch_context_surface.suffix': ' + 1…0',
  'settings.zedcode.keyboardShortcuts.action.new_chat.label': 'New session',
  'settings.zedcode.keyboardShortcuts.action.new_chat_worktree.label': 'New worktree draft',
  'settings.zedcode.keyboardShortcuts.action.new_mini_chat.label': 'New Mini Chat window',
  'settings.zedcode.keyboardShortcuts.action.open_help.label': 'Open keyboard shortcuts',
  'settings.zedcode.keyboardShortcuts.action.toggle_context_plan.label': 'Toggle plan context panel',
  'settings.zedcode.keyboardShortcuts.action.toggle_services_menu.label': 'Toggle services menu',
  'settings.zedcode.keyboardShortcuts.action.cycle_services_tab.label': 'Cycle services tab',
  'settings.zedcode.keyboardShortcuts.action.cycle_theme.label': 'Cycle theme',
  'settings.zedcode.keyboardShortcuts.action.cycle_agent.label': 'Cycle agent',
  'settings.zedcode.keyboardShortcuts.action.cycle_favorite_model_forward.label': 'Cycle favorite model forward',
  'settings.zedcode.keyboardShortcuts.action.cycle_favorite_model_backward.label': 'Cycle favorite model backward',
  'settings.zedcode.keyboardShortcuts.action.open_model_selector.label': 'Open model selector',
  'settings.zedcode.keyboardShortcuts.action.expand_input.label': 'Expand input',
  'settings.zedcode.keyboardShortcuts.action.open_timeline_dialog.label': 'Open conversation timeline',
  'settings.zedcode.keyboardShortcuts.action.toggle_prompt_navigator.label': 'Toggle prompt navigator',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open ZedCode there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'ZedCode on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how ZedCode should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Local access',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Choose the local address used to open this remote ZedCode server.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote ZedCode UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How ZedCode should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.phase.installingZedCode': 'Installing ZedCode',
  'settings.remoteInstances.page.phase.updatingZedCode': 'Updating ZedCode',
  ...
  'settings.zedcode.worktrees.state.selectProject': 'Select a project to manage worktrees.',
  'settings.zedcode.worktrees.state.gitOnly': 'Worktree settings are only available for Git repositories.',
  'settings.zedcode.worktrees.setup.title': 'Setup commands',
  'settings.zedcode.worktrees.setup.tooltipPrefix': 'Run automatically inside the new worktree directory when a worktree is created. Use',
  'settings.zedcode.worktrees.setup.tooltipSuffix': 'for the project root.',
  'settings.zedcode.worktrees.setup.loading': 'Loading...',
  'settings.zedcode.worktrees.setup.commandPlaceholder': 'e.g., bun install',
  'settings.zedcode.worktrees.setup.removeCommandAria': 'Remove command',
  'settings.zedcode.worktrees.setup.addCommand': 'Add command',
  'settings.zedcode.worktrees.setup.waitForCommands': 'Wait for setup commands before creating or sending a session',
  'settings.zedcode.worktrees.setup.waitForCommandsAria': 'Wait for Worktree setup commands before creating or sending a session',
  'settings.zedcode.worktrees.setup.toast.saveFailed': 'Failed to save worktree setup commands',
  'settings.zedcode.worktrees.list.title': 'Existing worktrees',
  'settings.zedcode.worktrees.list.tooltip': 'Deleting a worktree also removes its linked sessions.',
  'settings.zedcode.worktrees.list.loading': 'Loading worktrees...',
  'settings.zedcode.worktrees.list.empty': 'No worktrees found for this project',
  'settings.zedcode.worktrees.list.detachedHead': 'Detached HEAD',
  'settings.zedcode.worktrees.list.deleteWorktreeAria': 'Delete worktree {name}',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Stored in OpenCode auth, not by ZedCode. Use {env:VAR_NAME} to read a key from the environment instead.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by ZedCode.',
  ...
  'settings.zedcode.defaults.title': 'Session Defaults',
  'settings.zedcode.defaults.summaryPrefix': 'New sessions will start with:',
  'settings.zedcode.defaults.summaryOpenCodeDefault': 'OpenCode agent default',
  'settings.zedcode.defaults.field.defaultModel': 'Default Model',
  'settings.zedcode.defaults.field.defaultThinking': 'Default Thinking',
  'settings.zedcode.defaults.field.thinkingPlaceholder': 'Thinking',
  'settings.zedcode.defaults.field.defaultAgent': 'Default Agent',
  'settings.zedcode.defaults.field.showDeletionDialogAria': 'Show deletion dialog',
  'settings.zedcode.defaults.field.showDeletionDialog': 'Show Deletion Dialog',
  'settings.zedcode.defaults.smallModel.title': 'Small Model',
  'settings.zedcode.defaults.smallModel.description': 'A cheap model for quick utility tasks like short recaps and summaries.',
  'settings.zedcode.defaults.smallModel.useDefault': 'Use default small model',
  'settings.zedcode.defaults.smallModel.useDefaultAria': 'Use default small model',
  'settings.zedcode.defaults.smallModel.overrideModel': 'Override model',
  'settings.zedcode.defaults.walkthroughModel.title': 'Changes Walkthrough Model',
  ...
  'settings.zedcode.defaults.walkthroughModel.overrideModel': 'Walkthrough model',
  'settings.zedcode.defaults.walkthroughModel.usesSmallModel': 'Small model',
  'settings.zedcode.defaults.field.openFilesPreviewAria': 'Open previewable files in preview mode',
  'settings.zedcode.defaults.field.openFilesPreview': 'Open previewable files in preview mode',
  'settings.zedcode.defaults.option.default': 'Default',
  'settings.zedcode.defaults.option.defaultLowercase': 'default',
  'settings.zedcode.git.title': 'Git Preferences',
  'settings.zedcode.git.changesViewTitle': 'Changes View',
  'settings.zedcode.git.changesViewAria': 'Git changes view mode',
  'settings.zedcode.git.option.flatList': 'Flat List',
  'settings.zedcode.git.option.treeView': 'Tree View',
  'settings.zedcode.git.optionAria': 'Git changes view mode: {option}',
  'settings.zedcode.git.enableGitmojiAria': 'Enable Gitmoji picker',
  'settings.zedcode.git.enableGitmoji': 'Enable Gitmoji Picker',
  'settings.zedcode.git.showGitignoredAria': 'Display gitignored files',
  'settings.zedcode.git.showGitignored': 'Display Gitignored Files',
  ...
  'settings.github.page.flow.title': 'Authorize ZedCode',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if ZedCode auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from ZedCode.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'On-device transcription on the ZedCode server. Models download automatically; no API key needed.',
  'settings.voice.page.tooltip.localTts': 'On-device synthesis on the ZedCode server (Kokoro, English). The model downloads automatically; no API key needed.',
  ...
  'settings.zedcode.visual.section.colorMode': 'Color Mode',
  'settings.zedcode.visual.section.colorModeAndTheme': 'Color mode & Theme',
  'settings.zedcode.visual.section.mobileLayout': 'Mobile Layout',
  'settings.zedcode.visual.option.mobileLayout.default': 'Old',
  'settings.zedcode.visual.option.mobileLayout.new': 'New',
  'settings.zedcode.visual.section.localization': 'Localization',
  'settings.zedcode.visual.section.spacingAndLayout': 'Spacing & Layout',
  'settings.zedcode.visual.section.densityAndType': 'Density & type',
  'settings.zedcode.visual.section.appInstall': 'App install',
  'settings.zedcode.visual.section.navigation': 'Navigation',
  'settings.zedcode.visual.section.chatRenderMode': 'Chat Render Mode',
  'settings.zedcode.visual.section.chatRenderModeAria': 'Chat render mode',
  'settings.zedcode.visual.section.chatDisplay': 'Display',
  'settings.zedcode.visual.section.chatMessageOptions': 'Message options',
  'settings.zedcode.visual.section.chatFeatures': 'Features',
  'settings.zedcode.visual.section.messageStreamTransport': 'Message Stream Transport',
  'settings.zedcode.visual.section.activityDefault': 'Activity Default',
  'settings.zedcode.visual.section.activityDefaultAria': 'Activity default mode',
  'settings.zedcode.visual.section.showToolsOpenedByDefault': 'Show tools opened by default',
  'settings.zedcode.visual.section.sessionAssistance': 'Session Assistance',
  'settings.zedcode.visual.section.reasoning': 'Reasoning',
  'settings.zedcode.visual.section.messageAppearance': 'Message Appearance',
  'settings.zedcode.visual.section.toolsAndFiles': 'Tools & Files',
  'settings.zedcode.visual.section.composer': 'Composer',
  'settings.zedcode.visual.section.userMessageRendering': 'User Message Rendering',
  'settings.zedcode.visual.section.userMessageRenderingAria': 'User message rendering mode',
  'settings.zedcode.visual.section.mermaidRendering': 'Mermaid Rendering',
  'settings.zedcode.visual.section.mermaidRenderingAria': 'Mermaid rendering mode',
  'settings.zedcode.visual.section.diffLayout': 'Diff Layout',
  'settings.zedcode.visual.section.diffLayoutAria': 'Diff layout',
  'settings.zedcode.visual.section.privacy': 'Privacy',
  'settings.zedcode.visual.field.lightTheme': 'Light Theme',
  'settings.zedcode.visual.field.darkTheme': 'Dark Theme',
  'settings.zedcode.visual.field.selectLightThemeAria': 'Select light theme',
  'settings.zedcode.visual.field.selectDarkThemeAria': 'Select dark theme',
  'settings.zedcode.visual.field.selectThemePlaceholder': 'Select theme',
  'settings.zedcode.visual.field.timeFormat': 'Time Format',
  'settings.zedcode.visual.field.weekStartsOn': 'Week Starts On',
  'settings.zedcode.visual.field.selectTimeFormatAria': 'Select time format',
  'settings.zedcode.visual.field.selectWeekStartAria': 'Select week start',
  'settings.zedcode.visual.actions.reloadThemes': 'Reload themes',
  'settings.zedcode.visual.actions.reloadingThemes': 'Reloading themes...',
  'settings.zedcode.visual.field.dockBadge': 'Dock badge',
  'settings.zedcode.visual.field.dockBadgeHint': 'Show a count of chats with unseen activity on the macOS dock icon.',
  'settings.zedcode.visual.actions.saveAndRestart': 'Save & restart',
  'settings.zedcode.visual.actions.restarting': 'Restarting…',
  'settings.zedcode.visual.field.themeImportInfoAria': 'Theme import info',
  'settings.zedcode.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/zedcode/themes/',
  'settings.zedcode.visual.field.installAppName': 'Install App Name',
  'settings.zedcode.visual.field.installAppNameHint': 'Used by PWA installation process.',
  'settings.zedcode.visual.field.pwaInstallAppNameAria': 'PWA install app name',
  'settings.zedcode.visual.actions.resetInstallAppNameAria': 'Reset install app name',
  'settings.zedcode.visual.field.installOrientation': 'Install Orientation',
  'settings.zedcode.visual.field.installOrientationHint': 'Used by the installed web app. Reinstall the PWA after changing this.',
  'settings.zedcode.visual.field.pwaInstallOrientationAria': 'PWA install orientation',
  'settings.zedcode.visual.field.selectOrientationPlaceholder': 'Select orientation',
  'settings.zedcode.visual.actions.resetInstallOrientationAria': 'Reset install orientation',
  'settings.zedcode.visual.field.mobileKeyboardMode': 'Mobile Keyboard Behavior',
  'settings.zedcode.visual.field.mobileKeyboardModeHint': 'Default browser behavior is safest. Resize content asks supported browsers to shrink the app when the on-screen keyboard opens.',
  'settings.zedcode.visual.field.mobileKeyboardModeAria': 'Mobile keyboard behavior',
  'settings.zedcode.visual.field.selectMobileKeyboardModePlaceholder': 'Select keyboard behavior',
  'settings.zedcode.visual.actions.resetMobileKeyboardModeAria': 'Reset mobile keyboard behavior',
  'settings.zedcode.visual.field.interfaceFontSize': 'Interface Font Size',
  'settings.zedcode.visual.field.interfaceFont': 'Interface Font',
  'settings.zedcode.visual.field.selectInterfaceFontAria': 'Select interface font',
  'settings.zedcode.visual.actions.resetInterfaceFontAria': 'Reset interface font',
  'settings.zedcode.visual.field.fontSizePercentageAria': 'Font size percentage',
  'settings.zedcode.visual.actions.resetFontSizeAria': 'Reset font size',
  'settings.zedcode.visual.field.terminalFontSize': 'Terminal Font Size',
  'settings.zedcode.visual.field.terminalShell': 'Terminal Shell',
  'settings.zedcode.visual.field.terminalShellAria': 'Select terminal shell',
  'settings.zedcode.visual.field.terminalShellHint': 'Restart the terminal to apply this change to the current session.',
  'settings.zedcode.visual.field.terminalLoginShell': 'Start as login shell',
  'settings.zedcode.visual.option.terminalShell.auto': 'Auto',
  'settings.zedcode.visual.field.editorFontSize': 'Editor Font Size',
  'settings.zedcode.visual.field.codeFont': 'Code Font',
  'settings.zedcode.visual.field.selectCodeFontAria': 'Select code font',
  'settings.zedcode.visual.actions.resetCodeFontAria': 'Reset code font',
  'settings.zedcode.visual.actions.resetTerminalFontSizeAria': 'Reset terminal font size',
  'settings.zedcode.visual.actions.resetEditorFontSizeAria': 'Reset editor font size',
  'settings.zedcode.visual.field.spacingDensity': 'Spacing Density',
  'settings.zedcode.visual.actions.resetSpacingAria': 'Reset spacing',
  'settings.zedcode.visual.field.inputBarOffset': 'Input Bar Offset',
  'settings.zedcode.visual.field.inputBarOffsetTooltip': 'Raise input bar to avoid OS-level screen obstructions like home bars.',
  'settings.zedcode.visual.actions.resetInputBarOffsetAria': 'Reset input bar offset',
  'settings.zedcode.visual.field.terminalQuickKeysAria': 'Terminal quick keys',
  'settings.zedcode.visual.field.terminalQuickKeys': 'Terminal Quick Keys',
  'settings.zedcode.visual.field.terminalQuickKeysTooltip': 'Show Esc, Ctrl, Arrows in terminal view',
  'settings.zedcode.visual.field.fileEditorKeymap': 'File editor keymap',
  'settings.zedcode.visual.option.fileEditorKeymap.default': 'Default',
  'settings.zedcode.visual.option.fileEditorKeymap.vim': 'Vim',
  'settings.zedcode.visual.field.activityDefaultModeAria': 'Activity default mode: {option}',
  'settings.zedcode.visual.field.showExpandedBashToolsAria': 'Show expanded bash tools',
  'settings.zedcode.visual.field.showExpandedEditToolsAria': 'Show expanded edit tools',
  'settings.zedcode.visual.field.bash': 'Bash',
  'settings.zedcode.visual.field.editTools': 'Edit tools',
  'settings.zedcode.visual.field.userMessageRenderingAria': 'User message rendering: {option}',
  ...
  'settings.zedcode.visual.field.sessionRecap': 'Generate Session Recap',
  'settings.zedcode.visual.field.sessionRecapAria': 'Generate a recap after the agent finishes',
  'settings.zedcode.visual.field.sessionSuggestion': 'Generate Next User Message Suggestion',
  'settings.zedcode.visual.field.sessionSuggestionAria': 'Generate a suggested next user message after the agent finishes',
  'settings.zedcode.visual.field.sessionGoal': 'Enable Session Goals',
  'settings.zedcode.visual.field.sessionGoalAria': 'Keep the session working toward a goal automatically',
  'settings.zedcode.visual.goal.sectionTitle': 'Goal',
  'settings.zedcode.visual.goal.budgetLabel': 'Default token budget',
  'settings.zedcode.visual.goal.budgetAria': 'Apply a default token budget to new goals',
  'settings.zedcode.visual.goal.description': 'Arm the target button in the composer and the next message becomes a goal: the agent keeps working toward it automatically, audited by the small model, even while you are away.',
  'settings.zedcode.visual.field.showReasoningTracesAria': 'Show reasoning traces',
  'settings.zedcode.visual.field.showReasoningTraces': 'Show Reasoning Traces',
  'settings.zedcode.visual.field.collapsibleThinkingBlocksAria': 'Enable collapsible reasoning blocks',
  'settings.zedcode.visual.field.collapsibleThinkingBlocks': 'Enable Collapsible Reasoning Blocks',
  'settings.zedcode.visual.field.collapsibleUserMessagesAria': 'Collapse long user messages',
  'settings.zedcode.visual.field.collapsibleUserMessages': 'Collapse Long User Messages',
  'settings.zedcode.visual.field.stickyUserHeaderAria': 'Sticky user header',
  'settings.zedcode.visual.field.stickyUserHeader': 'Sticky User Header',
  ...
  'settings.zedcode.visual.field.autoSaveEnabledAria': 'Auto-save files',
  'settings.zedcode.visual.field.autoSaveEnabled': 'Auto-save files',
  'settings.zedcode.visual.field.autoSaveEnabledInfo': 'Automatically save file edits after you stop typing. Disable to require manual save.',
  'settings.zedcode.visual.field.wideChatLayoutAria': 'Wide chat layout',
  'settings.zedcode.visual.field.wideChatLayout': 'Wide Chat Layout',
  'settings.zedcode.visual.field.codeBlockLineWrapAria': 'Wrap code block lines',
  'settings.zedcode.visual.field.codeBlockLineWrap': 'Wrap Code Block Lines',
  'settings.zedcode.visual.field.showSplitAssistantMessageActionsAria': 'Inline assistant actions',
  'settings.zedcode.visual.field.showSplitAssistantMessageActions': 'Inline Assistant Actions',
  'settings.zedcode.visual.field.showSplitAssistantMessageActionsTooltip': 'Show Copy Answer, Save as image, and Read aloud on assistant text blocks that appear before later tool calls in the same response.',
  'settings.zedcode.visual.field.allowPromptingSubagentSessionsAria': 'Allow prompting subagent sessions',
  'settings.zedcode.visual.field.allowPromptingSubagentSessions': 'Allow Prompting Subagent Sessions',
  'settings.zedcode.visual.field.draftStartersVisible': 'Show Starters on New Session Screen',
  'settings.zedcode.visual.field.draftStartersVisibleAria': 'Show starters on the new session screen',
  'settings.zedcode.visual.field.showToolFileIconsAria': 'Show tool file icons',
  'settings.zedcode.visual.field.showToolFileIcons': 'Show Tool File Icons',
  'settings.zedcode.visual.field.showTurnChangedFilesAria': 'Show changed files for completed turns',
  'settings.zedcode.visual.field.showTurnChangedFiles': 'Show Changed Files for Completed Turns',
  'settings.zedcode.visual.field.showDotfilesAria': 'Show dotfiles',
  'settings.zedcode.visual.field.showDotfiles': 'Show Dotfiles',
  'settings.zedcode.visual.field.queueMessagesByDefaultAria': 'Queue messages by default',
  'settings.zedcode.visual.field.queueMessagesByDefault': 'Queue Messages by Default',
  'settings.zedcode.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages. Use {modifier}+Enter to send.',
  'settings.zedcode.visual.field.persistDraftMessagesAria': 'Persist draft messages',
  'settings.zedcode.visual.field.persistDraftMessages': 'Persist Draft Messages',
  'settings.zedcode.visual.field.enableSpellcheckInTextInputsAria': 'Enable spellcheck in text inputs',
  'settings.zedcode.visual.field.enableSpellcheckInTextInputs': 'Enable Spellcheck in Text Inputs',
  'settings.zedcode.visual.field.sendAnonymousUsageReportsAria': 'Send anonymous usage reports',
  'settings.zedcode.visual.field.sendAnonymousUsageReports': 'Send anonymous usage reports',
  'settings.zedcode.visual.field.sendAnonymousUsageReportsHint': 'Helps us understand which app versions are actively used so we can prioritize improvements. Only app version, platform, and runtime are collected - no personal data or code.',
  'settings.zedcode.visual.option.themeMode.system': 'System',
  'settings.zedcode.visual.option.themeMode.system.description': 'Follow system setting',
  'settings.zedcode.visual.option.themeMode.light': 'Light',
  'settings.zedcode.visual.option.themeMode.light.description': 'Always use light appearance',
  'settings.zedcode.visual.option.themeMode.dark': 'Dark',
  'settings.zedcode.visual.option.themeMode.dark.description': 'Always use dark appearance',
  'settings.zedcode.visual.option.diffLayout.dynamic.label': 'Dynamic',
  'settings.zedcode.visual.option.diffLayout.dynamic.description': 'New inline, modified side-by-side.',
  'settings.zedcode.visual.option.diffLayout.inline.label': 'Always inline',
  'settings.zedcode.visual.option.diffLayout.inline.description': 'Show as a single unified view.',
  'settings.zedcode.visual.option.diffLayout.sideBySide.label': 'Always side-by-side',
  'settings.zedcode.visual.option.diffLayout.sideBySide.description': 'Compare original and modified files.',
  'settings.zedcode.visual.option.mermaidRendering.svg.label': 'SVG',
  'settings.zedcode.visual.option.mermaidRendering.svg.description': 'Render diagrams as scalable graphics.',
  'settings.zedcode.visual.option.mermaidRendering.ascii.label': 'ASCII',
  'settings.zedcode.visual.option.mermaidRendering.ascii.description': 'Render diagrams as text blocks.',
  'settings.zedcode.visual.option.pwaOrientation.system.label': 'Follow system',
  'settings.zedcode.visual.option.pwaOrientation.system.description': 'Respect the device rotation setting.',
  'settings.zedcode.visual.option.pwaOrientation.portrait.label': 'Portrait lock',
  'settings.zedcode.visual.option.pwaOrientation.portrait.description': 'Install the app locked to portrait.',
  'settings.zedcode.visual.option.pwaOrientation.landscape.label': 'Landscape lock',
  'settings.zedcode.visual.option.pwaOrientation.landscape.description': 'Install the app locked to landscape.',
  'settings.zedcode.visual.option.mobileKeyboardMode.native.label': 'Follow browser',
  'settings.zedcode.visual.option.mobileKeyboardMode.native.description': 'Use the browser default for panning and viewport changes when the keyboard opens.',
  'settings.zedcode.visual.option.mobileKeyboardMode.resizeContent.label': 'Resize content',
  'settings.zedcode.visual.option.mobileKeyboardMode.resizeContent.description': 'Ask supported browsers to shrink the app layout instead of relying only on panning.',
  'settings.zedcode.visual.option.userMessageRendering.markdown.label': 'Markdown',
  'settings.zedcode.visual.option.userMessageRendering.markdown.description': 'Render user text with markdown formatting.',
  'settings.zedcode.visual.option.userMessageRendering.plain.label': 'Plain text',
  'settings.zedcode.visual.option.userMessageRendering.plain.description': 'Render user text with preserved whitespace and links.',
  'chat.message.userText.collapseAria': 'Collapse user message',
  'settings.zedcode.visual.option.chatRenderMode.sorted.label': 'Sorted',
  'settings.zedcode.visual.option.chatRenderMode.sorted.description': 'Render completed assistant messages without live streaming.',
  'settings.zedcode.visual.option.chatRenderMode.live.label': 'Live',
  'settings.zedcode.visual.option.chatRenderMode.live.description': 'Stream assistant text and tools as they arrive.',
  'settings.zedcode.visual.option.messageTransport.auto.label': 'Auto',
  'settings.zedcode.visual.option.messageTransport.auto.description': 'Prefer WebSocket and fall back to SSE if needed.',
  'settings.zedcode.visual.option.messageTransport.ws.label': 'WebSocket',
  'settings.zedcode.visual.option.messageTransport.ws.description': 'Use WebSocket for message streaming.',
  'settings.zedcode.visual.option.messageTransport.sse.label': 'SSE',
  'settings.zedcode.visual.option.messageTransport.sse.description': 'Use Server-Sent Events for message streaming.',
  'settings.zedcode.visual.option.activityRenderMode.collapsed.label': 'Collapsed',
  'settings.zedcode.visual.option.activityRenderMode.collapsed.description': 'Keep Activity collapsed by default.',
  'settings.zedcode.visual.option.activityRenderMode.summary.label': 'Expanded',
  'settings.zedcode.visual.option.activityRenderMode.summary.description': 'Expand Activity by default.',
  'settings.zedcode.visual.option.timeFormat.auto.label': 'Auto',
  'settings.zedcode.visual.option.timeFormat.auto.description': 'Use system locale preference.',
  'settings.zedcode.visual.option.timeFormat.24h.label': '24-hour',
  'settings.zedcode.visual.option.timeFormat.24h.description': 'Show time as 14:15.',
  'settings.zedcode.visual.option.timeFormat.12h.label': '12-hour',
  'settings.zedcode.visual.option.timeFormat.12h.description': 'Show time as 02:15 PM.',
  'settings.zedcode.visual.option.weekStart.auto.label': 'Auto',
  'settings.zedcode.visual.option.weekStart.auto.description': 'Use locale week start.',
  'settings.zedcode.visual.option.weekStart.monday.label': 'Monday',
  'settings.zedcode.visual.option.weekStart.sunday.label': 'Sunday',
