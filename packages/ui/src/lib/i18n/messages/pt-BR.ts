...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instale o ZedCode para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "ZedCode instalado",
  ...
  "mobile.connect.welcome.title": "Conectar ao ZedCode",
  ...
  "mobile.connect.password.placeholder": "Senha do ZedCode",
  ...
  "mobile.connect.scan.invalid": "Esse código QR não é um código de conexão do ZedCode.",
  ...
  "mobile.connect.error.unreachable": "Não foi possível acessar esse servidor ZedCode.",
  ...
  "sessions.sidebar.footer.actions.aboutZedCode": "Sobre o ZedCode",
  ...
  "walkthrough.blocked.serverUnsupported.description": "O servidor ZedCode ao qual este app está conectado não respondeu à API de walkthrough, ou seja, é mais antigo que o app. Atualize o servidor para 1.18 ou mais recente e atualize a visualização.",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} roda na máquina onde o ZedCode está e não foi possível abrir a conexão com ela. Nada da sua própria máquina é mostrado aqui.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Eles rodam na máquina que hospeda o ZedCode. Abri-los exige o aplicativo desktop.",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao ZedCode — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "filesView.editor.binaryFileDescription": "Este arquivo é binário e não pode ser editado no ZedCode. Baixe-o para abrir em outro aplicativo.",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "ZedCode precisa acessar esta pasta.",
  ...
  "aboutDialog.zedCodeVersionLabel": "Versão do ZedCode {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do ZedCode, a integridade do OpenCode, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo ZedCode com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do ZedCode",
  "header.actions.openAppMenuAria": "Abrir menu do ZedCode",
  ...
  "sessionAuth.error.networkDescription": "Não foi possível verificar a sessão da interface. Se você estiver abrindo o ZedCode de outro dispositivo na sua rede local, ative o Desktop Network Access no app para desktop e use o endereço LAN mostrado em Configurações.",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do ZedCode",
  ...
  "multiRun.window.description": "Janela do ZedCode Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao ZedCode",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o ZedCode não detectar o OpenCode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "OpenCode é o coração do ZedCode. Instale-o para começar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do ZedCode e recarregue configurações do OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do ZedCode para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor ZedCode ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do ZedCode. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando ZedCode, mas não é compatível com esta versão do app. Atualize o ZedCode no servidor e tente novamente.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando ZedCode. Verifique se o endereço aponta para um servidor ZedCode.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando ZedCode. Verifique se o endereço aponta para um servidor ZedCode.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Atualização do servidor necessária",
  "onboarding.desktopRecovery.remoteIncompatible.description": "O servidor ZedCode em \"{host}\" não é compatível com esta versão do app. Atualize o ZedCode no servidor e tente novamente.",
  ...
  "startup.initRecovery.description": "O ZedCode não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando ZedCode...",
  ...
  "updateDialog.error.takingLonger": "A atualização está demorando mais do que o esperado. Aguarde um pouco e atualize, ou execute: zedcode update",
  "mobileUpdate.toast.available.title": "Atualização do ZedCode disponível",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantenha o ZedCode aberto.",
  ...
  "zedCodeLogo.aria.logo": "Logo do ZedCode",
