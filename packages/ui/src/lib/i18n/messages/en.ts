...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install ZedCode for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'ZedCode installed',
  ...
  'mobile.connect.welcome.title': 'Connect to ZedCode',
  ...
  'mobile.connect.password.placeholder': 'ZedCode password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an ZedCode connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that ZedCode server.',
  ...
  'sessions.sidebar.footer.actions.aboutZedCode': 'About ZedCode',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'The ZedCode server this app is connected to did not answer the walkthrough API, which means it is older than the app. Update the server to 1.18 or newer, then refresh.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} runs on the machine ZedCode is on, and the connection to it could not be opened. Nothing from your own machine is shown here.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'These run on the machine hosting ZedCode. Opening them needs the desktop app.',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to ZedCode — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'filesView.editor.binaryFileDescription': 'This file is binary and cannot be edited in ZedCode. Download it to open with another app.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'ZedCode needs access to this folder.',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes ZedCode state, OpenCode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate ZedCode efficiently',
  ...
  'header.actions.openAppMenu': 'ZedCode menu',
  'header.actions.openAppMenuAria': 'Open ZedCode menu',
  ...
  'sessionAuth.error.networkDescription': 'We could not verify the UI session. If you\'re opening ZedCode from another device on your local network, make sure Desktop Network Access is enabled on the desktop app and use the LAN address shown in Settings.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock ZedCode',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote ZedCode servers',
  ...
  'multiRun.window.description': 'ZedCode Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to ZedCode',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If ZedCode does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of ZedCode — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to ZedCode settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an ZedCode server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an ZedCode server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different ZedCode version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running ZedCode but is not compatible with this app version. Update ZedCode on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running ZedCode. Verify the address points to an ZedCode server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running ZedCode. Verify the address points to an ZedCode server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The ZedCode server at "{host}" is not compatible with this app version. Update ZedCode on the server, then try again.',
  ...
  'startup.initRecovery.description': 'ZedCode could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating ZedCode...',
  ...
  'updateDialog.error.takingLonger': 'Update is taking longer than expected. Wait a bit and refresh, or run: zedcode update',
  'mobileUpdate.toast.available.title': 'ZedCode update available',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep ZedCode open.',
