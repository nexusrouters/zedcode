...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Installez ZedCode pour un accès plus rapide',
  'pwa.installPrompt.action': 'Installer',
  'pwa.installPrompt.dismiss': 'Ignorer',
  'pwa.installPrompt.started': 'Installation démarrée',
  'pwa.installPrompt.installed': 'ZedCode installé',
  ...
  'sessions.sidebar.footer.actions.aboutZedCode': 'À propos de ZedCode',
  ...
  'walkthrough.blocked.serverUnsupported.description': "Le serveur ZedCode auquel cette application est connectée n'a pas répondu à l'API walkthrough : il est donc plus ancien que l'application. Mettez le serveur à jour en 1.18 ou plus récent, puis actualisez.",
  ...
  'filesView.editor.binaryFileDescription': 'Ce fichier est binaire et ne peut pas être modifié dans ZedCode. Téléchargez-le pour l’ouvrir avec une autre application.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'ZedCode doit accéder à ce dossier.',
  ...
  'aboutDialog.zedCodeVersionLabel': 'Version ZedCode {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Comprend l’état ZedCode, l’état de santé OpenCode, les répertoires et les projets.',
  ...
  'helpDialog.description': 'Utilisez ces raccourcis clavier pour naviguer efficacement dans ZedCode',
  ...
  'header.actions.openAppMenu': 'Menu de ZedCode',
  'header.actions.openAppMenuAria': 'Ouvrir le menu ZedCode',
  ...
  'sessionAuth.error.networkDescription': 'Nous n\'avons pas pu vérifier la session d\'interface utilisateur. Si vous ouvrez ZedCode depuis un autre appareil sur votre réseau local, activez l\'accès au réseau du bureau dans l\'application de bureau et utilisez l\'adresse LAN indiquée dans les paramètres.',
  ...
  'sessionAuth.locked.unlockTitle': 'Débloquez ZedCode',
  ...
  'desktopHostSwitcher.description': 'Basculer entre les serveurs ZedCode locaux et distants',
  ...
  'multiRun.window.description': 'Fenêtre multi-exécution ZedCode.',
  ...
  'onboarding.chooser.title': 'Bienvenue sur ZedCode',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Si ZedCode ne détecte pas automatiquement OpenCode, définissez le chemin binaire ci-dessous.',
  'onboarding.localSetup.intro': 'OpenCode est le cœur de ZedCode — installez-le pour commencer.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Enregistre dans les paramètres ZedCode et recharge la configuration OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Saisissez l\'adresse d\'un serveur ZedCode auquel vous connecter.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions : vérifiez que l’URL pointe vers un serveur ZedCode ou contactez l\'administrateur du serveur.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Le serveur a répondu mais n\'exécute pas ZedCode. Vérifiez que l\'adresse pointe vers un serveur ZedCode.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Le serveur « {host} » n\'exécute pas ZedCode. Vérifiez que l\'adresse pointe vers un serveur ZedCode.',
  ...
  'startup.initRecovery.description': 'ZedCode n\'a pas pu terminer l\'initialisation. Vérifiez que le serveur est en cours d\'exécution, puis réessayez.',
  ...
  'updateDialog.header.updating': 'Mise à jour de ZedCode...',
  ...
  'updateDialog.error.takingLonger': 'La mise à jour prend plus de temps que prévu. Attendez un peu et actualisez, ou exécutez : zedcode update',
  'mobileUpdate.toast.available.title': 'Mise à jour ZedCode disponible',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Gardez ZedCode ouvert.',
  ...
  'mobile.connect.welcome.title': 'Se connecter à ZedCode',
  ...
  'mobile.connect.password.placeholder': 'Mot de passe ZedCode',
  ...
  'mobile.connect.scan.invalid': 'Ce code QR n\'est pas un code de connexion ZedCode.',
  ...
  'mobile.connect.relay.badge': 'via ZedCode Relay',
  ...
  'mobile.connect.error.unreachable': 'Impossible de joindre ce serveur ZedCode.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} tourne sur la machine où se trouve ZedCode, et la connexion vers elle n’a pas pu être ouverte. Rien de votre propre machine n’est affiché ici.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Ils tournent sur la machine qui héberge ZedCode. Les ouvrir nécessite l’application de bureau.',
  ...
  'contextPanel.browser.trustNotice': 'Les pages ouvertes ici s’exécutent avec un accès complet à ZedCode — nécessaire pour l’inspection et les captures d’écran. N’ouvrez que des sites de confiance : une page malveillante pourrait lire vos données ou agir en votre nom.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Cette instance utilise une version différente d’ZedCode. Vous pouvez vous connecter, mais mettez les deux applications à jour si quelque chose ne fonctionne pas.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Le serveur exécute ZedCode mais n’est pas compatible avec cette version de l’application. Mettez ZedCode à jour sur le serveur, puis réessayez.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Mise à jour du serveur requise',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Le serveur ZedCode à l’adresse « {host} » n’est pas compatible avec cette version de l’application. Mettez ZedCode à jour sur le serveur, puis réessayez.',
