...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.zedcode.visual.field.timeFormat',
    keywords: ['clock', '12h', '24h'],
  },
  {
    id: 'appearance.week-start',
    page: 'appearance',
    titleKey: 'settings.zedcode.visual.field.weekStartsOn',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.zedcode.visual.field.lightTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.zedcode.visual.field.darkTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.zedcode.visual.field.dockBadge',
    descriptionKey: 'settings.zedcode.visual.field.dockBadgeHint',
    keywords: ['dock', 'badge', 'unread', 'unseen', 'counter', 'count', 'notification', 'macos'],
    // Exactly matches the render guard in ZedCodeVisualSettings: any darwin
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.zedcode.visual.field.installAppName',
    descriptionKey: 'settings.zedcode.visual.field.installAppNameHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.zedcode.visual.field.installOrientation',
    descriptionKey: 'settings.zedcode.visual.field.installOrientationHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.zedcode.visual.field.mobileKeyboardMode',
    descriptionKey: 'settings.zedcode.visual.field.mobileKeyboardModeHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.zedcode.visual.field.interfaceFontSize',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.zedcode.visual.field.terminalFontSize',
    keywords: ['terminal', 'font', 'text size'],
  },
  {
    id: 'appearance.terminal-shell',
    page: 'general',
    titleKey: 'settings.zedcode.visual.field.terminalShell',
    descriptionKey: 'settings.zedcode.visual.field.terminalShellHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.zedcode.visual.field.editorFontSize',
    keywords: ['editor', 'font', 'text size', 'code'],
  },
  {
    id: 'appearance.spacing-density',
    page: 'appearance',
    titleKey: 'settings.zedcode.visual.field.spacingDensity',
    keywords: ['density', 'compact', 'comfortable', 'spacing'],
  },
  {
    id: 'appearance.input-bar-offset',
    page: 'appearance',
    titleKey: 'settings.zedcode.visual.field.inputBarOffset',
    descriptionKey: 'settings.zedcode.visual.field.inputBarOffsetTooltip',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.zedcode.visual.field.autoSaveEnabled',
    descriptionKey: 'settings.zedcode.visual.field.autoSaveEnabledInfo',
    keywords: ['editor', 'autosave', 'auto-save', 'files', 'save'],
  },
  {
    id: 'appearance.expanded-editor-toolbar',
    page: 'general',
    titleKey: 'settings.zedcode.visual.field.expandedEditorToolbar',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.zedcode.visual.field.fileEditorKeymap',
    keywords: ['editor', 'vim', 'keymap'],
  },
  {
    id: 'appearance.terminal-quick-keys',
    page: 'general',
    titleKey: 'settings.zedcode.visual.field.terminalQuickKeys',
    descriptionKey: 'settings.zedcode.visual.field.terminalQuickKeysTooltip',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.zedcode.visual.field.sendAnonymousUsageReports',
    descriptionKey: 'settings.zedcode.visual.field.sendAnonymousUsageReportsHint',
    keywords: ['telemetry', 'analytics'],
  },
  {
    id: 'chat.render-mode',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.section.chatRenderMode',
    keywords: ['messages', 'conversation', 'rendering'],
  },
  {
    id: 'chat.message-transport',
    page: 'general',
    titleKey: 'settings.zedcode.visual.section.messageStreamTransport',
    keywords: ['streaming', 'sse', 'websocket'],
  },
  {
    id: 'chat.session-recap',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.field.sessionRecap',
    keywords: ['recap', 'assist', 'small model', 'summary'],
  },
  {
    id: 'chat.session-assistance',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.section.sessionAssistance',
    keywords: ['recap', 'suggestion', 'subagent'],
  },
  {
    id: 'chat.session-suggestion',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.field.sessionSuggestion',
    keywords: ['suggestion', 'assist', 'small model', 'follow up'],
  },
  {
    id: 'chat.session-goal',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.field.sessionGoal',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.zedcode.visual.goal.budgetLabel',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.zedcode.visual.field.showReasoningTraces',
    keywords: ['thinking', 'reasoning'],
  },
  {
    id: 'chat.reasoning',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.section.reasoning',
    keywords: ['thinking', 'traces'],
  },
  {
    id: 'chat.sticky-user-header',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.field.stickyUserHeader',
    keywords: ['messages', 'header'],
  },
  {
    id: 'chat.prompt-navigator',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.field.promptNavigatorEnabled',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.zedcode.visual.field.collapsibleUserMessages',
    keywords: ['collapse', 'expand', 'clamp', 'long messages', 'user messages'],
  },
  {
    id: 'chat.wide-layout',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.field.wideChatLayout',
    keywords: ['layout', 'wide', 'messages'],
  },
  {
    id: 'chat.message-appearance',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.section.messageAppearance',
    keywords: ['layout', 'messages', 'appearance'],
  },
  {
    id: 'chat.code-block-line-wrap',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.field.codeBlockLineWrap',
    keywords: ['code', 'wrap', 'line wrap', 'markdown'],
  },
  {
    id: 'chat.inline-assistant-actions',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.field.showSplitAssistantMessageActions',
    descriptionKey: 'settings.zedcode.visual.field.showSplitAssistantMessageActionsTooltip',
    keywords: ['copy', 'save image', 'read aloud'],
  },
  {
    id: 'chat.draft-starters-visible',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.field.draftStartersVisible',
    keywords: ['starter', 'starters', 'new session', 'welcome', 'suggestions'],
  },
  {
    id: 'chat.subagent-read-only-banner',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.field.allowPromptingSubagentSessions',
    keywords: ['subagent', 'read only', 'prompt', 'banner'],
  },
  {
    id: 'chat.tool-file-icons',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.field.showToolFileIcons',
    keywords: ['tools', 'files', 'icons'],
  },
  {
    id: 'chat.tools-and-files',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.section.toolsAndFiles',
    keywords: ['tools', 'files', 'dotfiles'],
  },
  {
    id: 'chat.changed-files',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.field.showTurnChangedFiles',
    keywords: ['changed files', 'turns'],
  },
  {
    id: 'chat.dotfiles',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.field.showDotfiles',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.zedcode.visual.section.followUpBehavior',
    descriptionKey: 'settings.zedcode.visual.field.followUpBehaviorDescription',
    keywords: ['follow up', 'queue', 'steer', 'send immediately'],
  },
  {
    id: 'chat.persist-drafts',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.field.persistDraftMessages',
    keywords: ['draft', 'message'],
  },
  {
    id: 'chat.composer',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.section.composer',
    keywords: ['input', 'draft', 'spellcheck'],
  },
  {
    id: 'chat.spellcheck',
    page: 'chat',
    titleKey: 'settings.zedcode.visual.field.enableSpellcheckInTextInputs',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.zedcode.defaults.field.defaultModel',
    keywords: ['model', 'provider', 'new sessions'],
  },
  {
    id: 'sessions.default-thinking',
    page: 'sessions',
    titleKey: 'settings.zedcode.defaults.field.defaultThinking',
    keywords: ['thinking', 'reasoning', 'variant'],
  },
  {
    id: 'sessions.default-agent',
    page: 'sessions',
    titleKey: 'settings.zedcode.defaults.field.defaultAgent',
    keywords: ['agent', 'new sessions'],
  },
  {
    id: 'sessions.deletion-dialog',
    page: 'sessions',
    titleKey: 'settings.zedcode.defaults.field.showDeletionDialog',
    keywords: ['delete', 'confirmation'],
  },
  {
    id: 'sessions.small-model',
    page: 'sessions',
    titleKey: 'settings.zedcode.defaults.smallModel.title',
    descriptionKey: 'settings.zedcode.defaults.smallModel.description',
    keywords: ['small model', 'utility', 'summary', 'recap', 'cheap', 'override'],
  },
  {
    id: 'sessions.walkthrough-model',
    page: 'sessions',
    titleKey: 'settings.zedcode.defaults.walkthroughModel.title',
    descriptionKey: 'settings.zedcode.defaults.walkthroughModel.description',
    keywords: ['walkthrough', 'diff', 'review', 'changes', 'structured output', 'model', 'override'],
  },
  {
    id: 'sessions.auto-cleanup',
    page: 'sessions',
    titleKey: 'settings.zedcode.sessionRetention.field.enableAutoCleanup',
    descriptionKey: 'settings.zedcode.sessionRetention.tooltip',
    keywords: ['retention', 'archive', 'delete'],
  },
  {
    id: 'sessions.retention-period',
    page: 'sessions',
    titleKey: 'settings.zedcode.sessionRetention.field.retentionPeriod',
    keywords: ['days', 'cleanup', 'retention'],
  },
  {
    id: 'sessions.retention-action',
    page: 'sessions',
    titleKey: 'settings.zedcode.sessionRetention.field.whenSessionsExpire',
    keywords: ['archive', 'delete', 'expire'],
  },
  {
    id: 'sessions.desktop-launch-at-login',
    page: 'general',
    titleKey: 'settings.zedcode.desktopNetwork.field.launchAtLogin',
    descriptionKey: 'settings.zedcode.desktopNetwork.field.launchAtLoginDescription',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.zedcode.desktopNetwork.field.windowControlsPosition',
    descriptionKey: 'settings.zedcode.desktopNetwork.field.windowControlsPositionDescription',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.zedcode.desktopNetwork.field.windowControlsStyle',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.zedcode.desktopNetwork.field.macMenuBar',
    descriptionKey: 'settings.zedcode.desktopNetwork.field.macMenuBarDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.zedcode.desktopNetwork.field.minimizeToTray',
    descriptionKey: 'settings.zedcode.desktopNetwork.field.minimizeToTrayDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.zedcode.desktopNetwork.field.keepAwake',
    descriptionKey: 'settings.zedcode.desktopNetwork.field.keepAwakeDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.zedcode.desktopPassword.field.password',
    descriptionKey: 'settings.zedcode.desktopPassword.field.passwordDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.zedcode.desktopNetwork.field.allowLanAccess',
    descriptionKey: 'settings.zedcode.desktopNetwork.field.allowLanAccessDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.zedcode.opencodeCli.field.binaryPath',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.zedcode.opencodeCli.field.showUpdateNotifications',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.zedcode.tools.field.agentControlTool',
    descriptionKey: 'settings.zedcode.tools.field.agentControlToolInfo',
    keywords: ['agent', 'tool', 'orchestration', 'zedcode', 'sessions', 'schedule', 'control'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'sessions.agent-web-tool',
    page: 'general',
    titleKey: 'settings.zedcode.tools.field.agentWebTool',
    descriptionKey: 'settings.zedcode.tools.field.agentWebToolInfo',
    keywords: ['agent', 'tool', 'web', 'browser', 'page', 'preview', 'zedcode'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
  ...
  },
  {
    id: 'git.changes-view',
    page: 'git',
    titleKey: 'settings.zedcode.git.changesViewTitle',
    keywords: ['changes', 'flat list', 'tree view'],
  },
  {
    id: 'git.gitmoji',
    page: 'git',
    titleKey: 'settings.zedcode.git.enableGitmoji',
    keywords: ['commit', 'emoji'],
  },
  {
    id: 'git.gitignored-files',
    page: 'git',
    titleKey: 'settings.zedcode.git.showGitignored',
  ...
  },
  {
    ...
    page: 'projects',
    titleKey: 'settings.zedcode.worktrees.setup.waitForCommands',
  ...
  },
  {
    ...
    page: 'shortcuts',
    titleKey: 'settings.zedcode.keyboardShortcuts.title',
    descriptionKey: 'settings.zedcode.keyboardShortcuts.tooltip',
  ...
  },
  {
    id: 'tunnel.provider',
    page: 'tunnel',
    titleKey: 'settings.zedcode.tunnel.field.provider',
    descriptionKey: 'settings.zedcode.tunnel.description',
  ...
  },
  {
    id: 'tunnel.type',
    page: 'tunnel',
    titleKey: 'settings.zedcode.tunnel.field.tunnelType',
  ...
  },
  {
    id: 'tunnel.ttl',
    page: 'tunnel',
    titleKey: 'settings.zedcode.tunnel.field.connectLinkTtl',
    descriptionKey: 'settings.zedcode.tunnel.field.tunnelSessionTtl',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.zedcode.tunnel.section.savedManagedRemoteTunnels',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.zedcode.tunnel.field.configurationFile',
    descriptionKey: 'settings.zedcode.tunnel.note.managedLocalUsesConfig',
  ...
  },
  {
    id: 'tunnel.start',
    page: 'tunnel',
    titleKey: 'settings.zedcode.tunnel.actions.startTunnel',
    descriptionKey: 'settings.zedcode.tunnel.note.connectLinksOneTime',
  ...
  },
  {
    ...
    keywords: ['claude', 'anthropic', 'claude code', 'pro', 'max', 'agent sdk', '@zedcode/opencode-claude'],
  },
  {
    ...
    keywords: ['command code', 'commandcode', 'laguna', 'poolside', 'gateway', '@zedcode/opencode-commandcode'],
  },
  {
    ...
    keywords: ['cursor', 'oauth', 'subscription', 'openai compatible', '@zedcode/opencode-cursor'],
  },
] as const;
