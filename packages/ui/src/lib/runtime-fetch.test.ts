  ...
  test('rewrites current-origin absolute API URLs only', () => {
    ...
    try {
      ...
      Object.defineProperty(globalThis, 'window', {
        configurable: true,
        value: { location: { origin: 'zedcode-ui://app', href: 'zedcode-ui://app/index.html' } },
      });

      expect(buildRuntimeFetchUrl('zedcode-ui://app/api/config/settings')).toBe('https://api.example/api/config/settings');
