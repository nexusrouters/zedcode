...
import { getWorktreeSetupCommands, getWorktreeSetupWaitEnabled } from '@/lib/zedcodeConfig';
import {
...
const initializeSessionForWorktree = (sessionId: string, metadata: {
  ...
  sessionStore.initializeNewZedCodeSession(sessionId, configState.agents);
