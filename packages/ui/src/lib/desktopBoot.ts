 ...
 * it as `window.__ZEDCODE_DESKTOP_BOOT_OUTCOME__`. This module provides
...
export function getInjectedBootOutcome(): DesktopBootOutcome | null {
  ...
  const raw = (window as { __ZEDCODE_DESKTOP_BOOT_OUTCOME__?: unknown })
    .__ZEDCODE_DESKTOP_BOOT_OUTCOME__;
