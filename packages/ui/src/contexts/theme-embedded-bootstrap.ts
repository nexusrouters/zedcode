...
type ThemeBootstrapWindow = Window & {
  __zedcodeEmbeddedThemeBootstrap?: unknown;
};
...
export const publishEmbeddedThemeBootstrap = (theme: Theme): void => {
  ...
  (window as ThemeBootstrapWindow).__zedcodeEmbeddedThemeBootstrap = theme;
};
...
export const readEmbeddedThemeBootstrap = (): Theme | null => {
  ...
  try {
    ...
    return isValidTheme(parent.__zedcodeEmbeddedThemeBootstrap)
      ? parent.__zedcodeEmbeddedThemeBootstrap
      : null;
  } catch {
    return null;
  }
