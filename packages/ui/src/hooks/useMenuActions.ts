...
const MENU_ACTION_EVENT = 'zedcode:menu-action';
const CHECK_FOR_UPDATES_EVENT = 'zedcode:check-for-updates';
...
export const useMenuActions = (
  ...
  const handleAction = React.useCallback(
    (action: MenuAction) => {
      switch (action) {
        ...
        case 'copy': {
          const copyEvent = new Event('zedcode:copy', { cancelable: true });
  ...
  React.useEffect(() => {
    ...
    listen('zedcode:menu-action', (evt) => {
    ...
    listen('zedcode:check-for-updates', () => {
