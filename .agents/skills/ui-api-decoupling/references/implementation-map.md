...
- `packages/web/server/lib/opencode/core-routes.js`: installs ZedCode route families.
...
Explicit ZedCode routes must register before the generic `/api/*` OpenCode proxy.
