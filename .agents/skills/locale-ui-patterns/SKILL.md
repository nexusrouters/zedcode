...
description: Use when creating or modifying ZedCode UI text, labels, buttons, placeholders, aria labels, empty states, toasts, dialogs, settings copy, navigation labels, or any user-facing strings.
---
...
'chat.input.placeholder': 'Ask ZedCode...'
```
...
'Language': 'Language'
'chatLabel': 'Chat'
'askZedCodeDotDotDot': 'Ask ZedCode...'
```
...
- Product names: `ZedCode`, `OpenCode`, `GitHub`
